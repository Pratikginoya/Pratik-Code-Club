...
<head>
  ...
  <title>Log in | PratikCodeClub</title>
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Log in with PratikCodeClub</p>

      <form method="post" id="userLogin" action="{{ route('user_check') }}">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          @if (session()->has('success'))
            <div style="color:green; font-size: 14px;" class="ml-1">{{ session('success') }}</div>
          @endif
        </div>        
        ...
        <div class="row">
          ...
          <div class="col-2"></div>
          <div class="col-5">
            <a wire:navigate href="/register" class="btn btn-primary btn-block">Register Now</a>
          </div>
          <!-- <div class="col-7">
